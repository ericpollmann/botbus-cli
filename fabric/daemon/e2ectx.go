...
// it is virtually certain to exceed any counter a peer already saw before the
// restart; every counter issued after that for the same triple increments
// normally by 1 and remains strictly monotonic for the life of the process.
//
